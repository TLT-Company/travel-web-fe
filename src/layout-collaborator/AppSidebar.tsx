...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
    subItems: [{ name: "Ecommerce", path: "/collaborator", pro: false }],
  },
  // {
  //   icon: <GridIcon />,
  ...
  // },
  {
    ...
    name: "Tours",
    subItems: [
      { name: "Danh sách tours", path: "/collaborator/tours", pro: false },
      {
        name: "Chi tiết booking đã hoàn thành",
        path: "/collaborator/tours/completed_bookings", pro: false
      },
    ],
  },
];
