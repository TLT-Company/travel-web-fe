...
export default function ShowTourPage() {
  ...
  const IMAGE_URL = process.env.NEXT_PUBLIC_UPLOAD_IMAGE_URL;
  const images = [
    tour.image_url_1 && `${IMAGE_URL}${tour.image_url_1}`,
    tour.image_url_2 && `${IMAGE_URL}${tour.image_url_2}`,
    tour.image_url_3 && `${IMAGE_URL}${tour.image_url_3}`,
    tour.image_url_4 && `${IMAGE_URL}${tour.image_url_4}`,
    tour.image_url_5 && `${IMAGE_URL}${tour.image_url_5}`,
    tour.image_url_6 && `${IMAGE_URL}${tour.image_url_6}`,
    tour.image_url_7 && `${IMAGE_URL}${tour.image_url_7}`,
    tour.image_url_8 && `${IMAGE_URL}${tour.image_url_8}`,
    tour.image_url_9 && `${IMAGE_URL}${tour.image_url_9}`,
    tour.image_url_10 && `${IMAGE_URL}${tour.image_url_10}`,
  ].filter(Boolean);
